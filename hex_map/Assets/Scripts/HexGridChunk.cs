...
public class HexGridChunk : MonoBehaviour
{
    ...
    void TriangulateAdjacentToRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
        if (cell.HasRoads)
        {
            TriangulateRoadAdjancentToRiver(direction, cell, center, e);
        }
    ...
    void TriangulateRoadAdjancentToRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
